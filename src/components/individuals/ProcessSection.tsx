...
export default function ProcessSection() {
  ...
  return (
    <section className="py-20 bg-[#0A0A0F] relative overflow-hidden">
      {/* Ambient Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-amber-500/5 rounded-full blur-[150px] pointer-events-none"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="hidden lg:block">
          <div className="relative">
            {/* Connecting Line */}
            <div className="absolute top-12 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-y-1/2"></div>
              ...
              {processSteps.map((step, index) => (
                <div key={step.step} className="text-center group">
                  ...
                  <div className="px-2">
                    ...
                    {/* Time Indicator */}
                    <div className="flex items-center justify-center text-xs text-white/30 font-medium">
        ...
        <div className="lg:hidden">
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              {/* Vertical Line */}
              <div className="absolute left-6 top-0 bottom-0 w-px bg-gradient-to-b from-white/10 via-white/5 to-transparent -translate-x-1/2"></div>
                  ...
                  <div key={step.step} className="flex items-start group">
                    ...
                    <div className="ml-6 flex-1 pt-1">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <div className="flex items-center text-xs text-white/30 font-medium ml-2">
                          <Clock className="w-3 h-3 mr-1" />
                          {step.time}
                        </div>
                      </div>
                    ...
                    {/* Step Number */}
                    <div className="flex-shrink-0 ml-4 w-6 h-6 bg-white text-black text-xs font-bold rounded-full flex items-center justify-center shadow-md">
                      {step.step}
                    </div>
                  </div>
                ))}
        ...
        <div className="mt-16 bg-white/[0.03] backdrop-blur-xl rounded-2xl p-8 border border-white/10">
        ...
        <div className="text-center mt-12">
          <a
            ...
            className="inline-flex items-center bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-black font-semibold py-4 px-8 rounded-xl text-lg transition-all duration-300 transform hover:scale-105 shadow-[0_0_30px_rgba(245,158,11,0.25)] hover:shadow-[0_0_40px_rgba(245,158,11,0.4)] group"
          >
