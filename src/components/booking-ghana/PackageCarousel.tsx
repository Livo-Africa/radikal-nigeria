// src/components/booking-ghana/PackageCarousel.tsx
        ...
        <div className="w-full relative">
            ...
            >
                {packages.map((pkg) => {
                    ...
                    const duration = pkg.deliveryTime ? pkg.deliveryTime.replace(' hours', 'h') : '1-3h';
                            ...
                            `}>
                                <div className="relative w-24 h-24 flex items-center justify-center">
                                    ...
                                    <div className="relative z-10 flex flex-col items-center justify-center text-black leading-tight">
                                        ...
                                        <span className="text-xl font-black tracking-tight">{formatCurrency(displayPrice)}</span>
